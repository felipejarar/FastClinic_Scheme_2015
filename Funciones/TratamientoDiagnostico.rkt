...
#|
    ...
    Descripción: 
      Función utilizada para retornar una lista de tratamientoDiagnosticos construidos a partir de los registros contenidos en la base de datos TratamientoDiagnostico.txt. Se basa en el uso de una
      aplicación de recursión lineal, no por cola, para poder extraer cada uno de los registros y construir con ellos los diferentes tratamientoDiagnosticos contenidos en la base de datos.
...
#|
    ...
    Descripción: 
      Función utilizada para retornar una lista de todos los identificadores tratamientos contenidos en los registros. Recurre a una recursión del tipo lineal no por cola
      para obtener cada uno de los identificadores de cada uno de los registros y unirlos en una lista.
...
#|
    ...
    Descripción: 
      Función utilizada para retornar una lista de identificadores tratamientos relacionados con cierto identificador diagnostico. Utiliza una recursión del tipo
      lineal no por cola para unir cada uno de los identificadores obtenidos en una lista.
